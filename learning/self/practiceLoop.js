...
console.log(city2.toLowerCase().toLocaleLowerCase().length) //error (becoz return type for length
...
let city="Maharashtra"// l=11 L - 1= last index=10
console.log(city)
...
//verese loop ..city.length=11  index=length-1=10
let city="Maharashtra"
let reverseString=""
for(let i=city.length-1;i>=0;i--){      // we can also write 10 instead of (city.length-1)
    //console.log(i)                    // 11,10,9,8,7,....0
//console.log(city[i])                    //a,r,t,h,s,....M
reverseString=reverseString+city[i]
}
